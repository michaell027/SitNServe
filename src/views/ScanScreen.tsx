...
function ScanScreen({ navigation, route }) {
  ...
  const handleScanIssue = useCallback(() => {
    Alert.alert(
      ...
      [
        { text: "OK", onPress: () => console.log("Trouble scanning guidance provided.") }
      ]
    );
  }, []);
  ...
  <View style={{ flex: 1 }}>
    <View style={styles.topContentContainer}>
      <Text style={styles.centerText}>
        Scan the QR code{' '}
        <Text style={styles.textBold}>on your table</Text> to access our restaurant's menu.
      </Text>
    </View>
    ...
    <View style={{ flex: 1, justifyContent: 'space-between' }}>
      <QRCodeScanner
        ...
        showMarker={true}
        fadeIn={true}
        markerStyle={{borderColor: '#fff', borderRadius: 10, borderWidth: 2, borderStyle: 'dashed'}}
      />
      <TouchableOpacity
      ...
      >
        <Text style={styles.buttonText}>I have trouble with scanning</Text>
      </TouchableOpacity>
    </View>
  </View>
);
