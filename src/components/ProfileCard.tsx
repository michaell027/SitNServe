...
const formattedCreationDate = creationDate.toLocaleDateString('sk-SK');
            ...
            <View className="flex-1 p-5 bg-gray-200">
                <View className="p-5 bg-white rounded-2xl shadow-md">
                    <View className='flex flex-row w-full items-center space-x-4'>
                        ...
                        />
                        <View>
            <Text className="mt-2 text-2xl font-bold">Andrew Kumar</Text>
            <Text className="mt-1 text-sm text-gray-500">@andrewkumar</Text>
            </View>
</View>
                        ...
                        <Text>Sokoľany 259, Košice-okolie, 04457, Slovakia</Text>
                        </View>
    ...
    <View className='flex flex-col items-center w-1/2 p-1'>
                        ...
                        <Text className='text-lg text-gray-500 ml-2'>Favourite</Text>
                        </View>
                        <View className='flex flex-row mt-6 items-center space-x-4'>
                        <FontAwesomeIcon icon={faCreditCard} size={20} />
                        <Text className='text-lg text-gray-500 ml-2'>Payment methods</Text>
                        </View>
                        <View className='flex flex-row mt-6 items-center space-x-4'>
                        <FontAwesomeIcon icon={faBagShopping} size={20} />
                        <Text className='text-lg text-gray-500 ml-2'>My orders</Text>
                        </View>
                        <View className='flex flex-row mt-6 items-center space-x-4'>
                        <FontAwesomeIcon icon={faChair} size={20} />
                        <Text className='text-lg text-gray-500 ml-2'>My reservations</Text>
                        </View>
                        <View className='flex flex-row mt-6 items-center space-x-4'>
                        <FontAwesomeIcon icon={faStar} size={20} />
                        <Text className='text-lg text-gray-500 ml-2'>Reviews</Text>
                        </View>
...
<TouchableOpacity className="mt-4 px-4 py-2 bg-[#66b7b7] rounded-lg flex flex-row space-x-2 items-center">
                      <FontAwesomeIcon icon={faGears} color='#fff' size={20} />
                          <Text className="text-white font-bold">Edit Profile</Text>
                      </TouchableOpacity>
                        <TouchableOpacity className="mt-4 px-4 py-2 bg-red-400 rounded-lg flex flex-row space-x-2 items-center">
